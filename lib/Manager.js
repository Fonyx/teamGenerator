...
<div class="col s12 l6">
    <div class="card blue lighten-1">
        ...
        <div class="row">
            ...
            <div class="col">${this.name.toUpperCase()} THE ${this.getRole()}</div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col white-text"><i class="material-icons">work</i></div>
            <div class="col white-text ">Suite</div>
            <div class="col white-text right">${this.officeNumber}</div>
        </div>
        <div class="row">
