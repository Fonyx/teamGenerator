        ...
        <div class="card red lighten-1">
          <div class="card-content white-text">
            <div class="row">
                ...
                <div class="col">${this.name.toUpperCase()} THE INTERN</div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col orange-text"><i class="material-icons">school</i></div>
                <div class="col orange-text ">School</div>
                <div class="col orange-text right">${this.school}</div>
            </div>
            <div class="row">
